...
\frac{4z}{3z+1} &=& \frac{4}{3}\frac{1}{3z+1} - \frac{4}{3}\\
&=& \frac{4}{3}\left (\frac{1}{3z+1} - 1\right )\\
p(z<0.1)p(c=1|z<0.1) &=& \frac{4}{3}\int_0^{0.1} \frac{1}{3z+1}-1 dz\\
&=& \frac{4}{3}\left (\frac{1}{3} \ln(3z+1) - z\right ) \Bigg |_0^{0.1}\\
&=& \frac{4}{3}\left ( \frac{1}{3} \ln(1.3) - \frac{1}{10}\right )\\
&=& \frac{4}{9} \ln(1.3) -\frac{2}{45}
\end{eqnarray}
...
\begin{eqnarray}
\text{Classification error} = \frac{p(c=0|z<0.1)}{p(c=1|z<0.1)} &\approx & 25.63 \% 
\end{eqnarray}

Now we do the same for z$>$0.1.

\begin{eqnarray}
p(z>0.1)p(c=0|z>0.1) &=& \int_{0.1}^1 \frac{4}{9}\frac{1-z}{3z+1}dz\\
&=& \frac{4}{9} \left ( \frac{4}{9} \ln(3z+1) - \frac{z}{3}  \right )\Bigg | _{0.1}^{1}\\
&=& \frac{4}{9}\left [\left ( \frac{4}{9}\ln(4) - \frac{1}{3}\right ) - \left (\frac{4}{9}\ln(1.3) - \frac{1}{30} \right )\right ]
\end{eqnarray}
...
&=& \frac{4}{3}\left [ \left (\frac{1}{3}\ln(4) - 1\right ) - \left ( \frac{1}{3}\ln(1.3) - 0.1\right )\right ]
\end{eqnarray}

\begin{eqnarray}
\text{Classification error} = \frac{p(c=1|z>0.1)}{p(c=0|z>0.1)} &\approx & 25.63 \% 
\end{eqnarray}
