...
Regarding equation (\ref{eq:3}), $\mathcal{C}_1$ represents the posterior of class 1 given the feature vector $\phi$. $\sigma(a)$ represents the logistic sigmoid function defined by (see Bishop, page 197, eq. 4.59): 

\begin{align*}
\sigma(a) = \frac{1}{1 + \exp(-a)}
\end{align*} 

The standard logistic function is the same as the above (see: \url{https://en.wikipedia.org/wiki/Logistic_function}) and is defined  as
